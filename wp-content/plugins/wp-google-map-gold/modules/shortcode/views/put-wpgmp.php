...
$output = "<div class='row'><div class='col-12'>{$filters_div}</div><div class='col-lg-6 listing-map full-height'>{$listing_div}</div><div class='col-lg-6 full-map full-height'>{$map_div}</div></div>";
