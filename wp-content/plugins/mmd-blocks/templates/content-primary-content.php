            ...
            <div class="primary-content">
                ...
                <div class="second-navigation">
                    ...
                    <nav aria-labelledby="second-menu-nav-id">
                        <ul class="row">
                            <li class="col-lg-3 col-md-6"><a href="/map">Choose </br> a REGION </br> to explore</a></li>
                            <li class="col-lg-3 col-md-6"><a href="/map">Select </br> a CATEGORY </br> like to discover</a></li>
                            <li class="col-lg-3 col-md-6"><a href="/map">See </br> southern </br> HIGHLIGHTS</a></li>
