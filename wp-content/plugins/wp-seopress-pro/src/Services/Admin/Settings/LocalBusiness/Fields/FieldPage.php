...
trait FieldPage {
    ...
    public function renderFieldPage() {
        ...
        <input
            type="text"
            name="seopress_pro_option_name[seopress_local_business_page]"
            placeholder="<?php echo esc_html__('Enter your post, page or post type ID, eg: 64', 'wp-seopress-pro'); ?>"
            aria-label="<?php echo __('Post ID', 'wp-seopress-pro'); ?>"
