...
trait FieldCuisine {
    ...
    public function renderFieldCuisine() {
        ...
        <input
            type="text"
            name="seopress_pro_option_name[seopress_local_business_cuisine]"
            placeholder="<?php esc_html__('eg: French, Italian, Indian, American', 'wp-seopress-pro'); ?>"
            aria-label="<?php __('Cuisine served', 'wp-seopress-pro'); ?>"
