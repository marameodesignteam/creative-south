...
if ( ! empty($sp_schemas_ids)) {
    ...
    echo '<p class="sp-schema-count seopress-notice notice notice-info" data-count="' . $count . '">';
    ...
    foreach ($sp_schemas_ids as $id) {
        ...
        if ('jobs' == $seopress_pro_rich_snippets_type) {
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_employment_type) {
                ...
                echo '<span id="seopress-tag-employment-1" class="tag-title" data-tag="FULL_TIME"><span class="dashicons dashicons-plus"></span>FULL TIME</span>';
                echo '<span id="seopress-tag-employment-2" class="tag-title" data-tag="PART_TIME"><span class="dashicons dashicons-plus"></span>PART TIME</span>';
                echo '<span id="seopress-tag-employment-3" class="tag-title" data-tag="CONTRACTOR"><span class="dashicons dashicons-plus"></span>CONTRACTOR</span>';
                echo '<span id="seopress-tag-employment-4" class="tag-title" data-tag="TEMPORARY"><span class="dashicons dashicons-plus"></span>TEMPORARY</span>';
                echo '<span id="seopress-tag-employment-5" class="tag-title" data-tag="INTERN"><span class="dashicons dashicons-plus"></span>INTERN</span>';
                echo '<span id="seopress-tag-employment-6" class="tag-title" data-tag="VOLUNTEER"><span class="dashicons dashicons-plus"></span>VOLUNTEER</span>';
                echo '<span id="seopress-tag-employment-7" class="tag-title" data-tag="PER_DIEM"><span class="dashicons dashicons-plus"></span>PER_DIEM</span>';
                echo '<span id="seopress-tag-employment-8" class="tag-title" data-tag="OTHER"><span class="dashicons dashicons-plus"></span>OTHER</span>';
                echo '</span>
					</p>';
            }
    ...
    echo '<p><a class="button button-primary" href="' . admin_url('post-new.php?post_type=seopress_schemas') . '">' . __('Add a schema', 'wp-seopress-pro') . '</a></p>';
}
