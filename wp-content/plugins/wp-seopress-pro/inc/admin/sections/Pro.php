...
function print_pro_section($key)
{
    ...
    $sections = [
        'local-business'=> [
            ...
            'desc'   => sprintf(__('Local Business data type for Google. This schema will be displayed on the homepage. <br>You can also display these informations using our <a href="%1$s">Local Business widget</a> to optimize your site for <a class="seopress-help" href="%2$s" target="_blank" title="' . __('Optimizing WordPress sites for Google EAT (new window)', 'wp-seopress-pro') . '">Google EAT</a><span class="seopress-help dashicons dashicons-external"></span>.', 'wp-seopress-pro'), admin_url('widgets.php'), $docs['lb']['eat']),
        ],
        'edd'=> [
            'toggle' => 1,
