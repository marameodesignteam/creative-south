...
class seopress_pro_options {
    ...
    public function seopress_pro_page() {
        ...
        echo '</div>'; ?>
            ...
            echo 'active';
        } ?>" id="tab_seopress_breadcrumbs"><?php do_settings_sections('seopress-settings-admin-breadcrumbs'); ?></div>
            ...
            echo 'active';
        } ?>" id="tab_seopress_404"><?php do_settings_sections('seopress-settings-admin-monitor-404'); ?></div>

			<!-- htaccess -->
			<?php if ( ! is_multisite()) { ?>
				<div class="seopress-tab <?php if ('tab_seopress_htaccess' == $current_tab) {
            echo 'active';
        } ?>" id="tab_seopress_htaccess"><?php do_settings_sections('seopress-settings-admin-htaccess'); ?></div>
			<?php } ?>

			<!-- RSS -->
			<div class="seopress-tab <?php if ('tab_seopress_rss' == $current_tab) {
            echo 'active';
        } ?>" id="tab_seopress_rss"><?php do_settings_sections('seopress-settings-admin-rss'); ?></div>

			<!-- Rewrite -->
			<div class="seopress-tab <?php if ('tab_seopress_rewrite' == $current_tab) {
            echo 'active';
        } ?>" id="tab_seopress_rewrite"><?php do_settings_sections('seopress-settings-admin-rewrite'); ?></div>

			<!-- White Label -->
			<?php if ( ! is_multisite()) { ?>
				<div class="seopress-tab <?php if ('tab_seopress_white_label' == $current_tab) {
            echo 'active';
        } ?>" id="tab_seopress_white_label"><?php do_settings_sections('seopress-settings-admin-white-label'); ?></div>
			<?php } ?>
        ...
        if (is_plugin_active('wp-seopress/seopress.php')) {
            ...
            echo '</div>'; ?>
                ...
                echo 'active';
					...
					<div class="seopress-tab <?php if ('tab_seopress_white_label' == $current_tab) {
                echo 'active';
            } ?>" id="tab_seopress_white_label"><?php do_settings_sections('seopress-mu-settings-admin-white-label'); ?></div>
    ...
    public function page_init() {
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_bot'], // Callback
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_bot_settings'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_bot_scan_settings_post_types_callback'], // Callback
            'seopress-settings-admin-bot-settings', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_bot_scan_settings_where_callback'], // Callback
            'seopress-settings-admin-bot-settings', // Page
            'seopress_setting_section_bot_settings' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_bot_scan_settings_number_callback'], // Callback
            'seopress-settings-admin-bot-settings', // Page
            'seopress_setting_section_bot_settings' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_bot_scan_settings_type_callback'], // Callback
            'seopress-settings-admin-bot-settings', // Page
            'seopress_setting_section_bot_settings' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_bot_scan_settings_404_callback'], // Callback
            'seopress-settings-admin-bot-settings', // Page
            'seopress_setting_section_bot_settings' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_bot_scan_settings_timeout_callback'], // Callback
            'seopress-settings-admin-bot-settings', // Page
            'seopress_setting_section_bot_settings' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_bot_scan_settings_cleaning_callback'], // Callback
            'seopress-settings-admin-bot-settings', // Page
            'seopress_setting_section_bot_settings' // Section
        );
        ...
        if (apply_filters('seopress_pro_fallback_local_business_settings', false)) {
            ...
            add_settings_section(
                ...
                [$this, 'print_section_info_local_business'], // Callback
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_page_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_type_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_street_address_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_address_locality_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_address_region_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_postal_code_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_address_country_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_lat_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_lon_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );

            add_settings_field(
                'seopress_local_business_place_id', // ID
                __('Place ID', 'wp-seopress-pro'), // Title
                [$this, 'seopress_local_business_place_id_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_url_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_phone_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_price_range_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_cuisine_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_local_business_opening_hours_callback'], // Callback
                'seopress-settings-admin-local-business', // Page
                'seopress_setting_section_local_business' // Section
            );
        }
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_woocommerce'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_cart_page_no_index_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_checkout_page_no_index_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
            'seopress_setting_section_woocommerce' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_customer_account_page_no_index_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
            'seopress_setting_section_woocommerce' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_product_og_price_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
            'seopress_setting_section_woocommerce' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_product_og_currency_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
            'seopress_setting_section_woocommerce' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_meta_generator_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
            'seopress_setting_section_woocommerce' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_schema_output_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
            'seopress_setting_section_woocommerce' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_woocommerce_schema_breadcrumbs_output_callback'], // Callback
            'seopress-settings-admin-woocommerce', // Page
            'seopress_setting_section_woocommerce' // Section
        );
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_edd'], // Callback
        ...
        add_settings_field(
            ...
            __('OG Price', 'wp-seopress-pro'), // Title
            [$this, 'seopress_edd_product_og_price_callback'], // Callback
            'seopress-settings-admin-edd', // Page
        ...
        add_settings_field(
            ...
            __('OG Currency', 'wp-seopress-pro'), // Title
            [$this, 'seopress_edd_product_og_currency_callback'], // Callback
            'seopress-settings-admin-edd', // Page
            'seopress_setting_section_edd' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_edd_meta_generator_callback'], // Callback
            'seopress-settings-admin-edd', // Page
            'seopress_setting_section_edd' // Section
        );
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_dublin_core'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_dublin_core_enable_callback'], // Callback
            'seopress-settings-admin-dublin-core', // Page
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_rich_snippets'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rich_snippets_enable_callback'], // Callback
            'seopress-settings-admin-rich-snippets', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rich_snippets_publisher_logo_callback'], // Callback
            'seopress-settings-admin-rich-snippets', // Page
            'seopress_setting_section_rich_snippets' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rich_snippets_site_nav_callback'], // Callback
            'seopress-settings-admin-rich-snippets', // Page
            'seopress_setting_section_rich_snippets' // Section
        );
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_breadcrumbs'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_enable_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_enable_json_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_separator_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_cpt_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_tax_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_i18n_here_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_i18n_home_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_i18n_404_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_i18n_search_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_i18n_no_results_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_remove_blog_page_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_remove_shop_page_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_breadcrumbs_separator_disable_callback'], // Callback
            'seopress-settings-admin-breadcrumbs', // Page
            'seopress_setting_section_breadcrumbs' // Section
        );
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_page_speed'], // Callback
        ...
        if (is_network_admin() && is_multisite()) {
            ...
            add_settings_field(
                ...
                [$this, 'seopress_robots_file_callback'], // Callback
                'seopress-mu-settings-admin-robots', // Page
                'seopress_mu_setting_section_robots' // Section
            );
        } else {
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_news'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_news_enable_callback'], // Callback
            'seopress-settings-admin-news', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_news_name_callback'], // Callback
            'seopress-settings-admin-news', // Page
            'seopress_setting_section_news' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_news_name_post_types_list_callback'], // Callback
            'seopress-settings-admin-news', // Page
            'seopress_setting_section_news' // Section
        );
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_monitor_404'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_404_enable_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_404_cleaning_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
            'seopress_setting_section_monitor_404' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_404_redirect_home_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
            'seopress_setting_section_monitor_404' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_404_redirect_custom_url_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
            'seopress_setting_section_monitor_404' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_404_redirect_status_code_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
            'seopress_setting_section_monitor_404' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_404_enable_mails_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
            'seopress_setting_section_monitor_404' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_404_enable_mails_from_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
            'seopress_setting_section_monitor_404' // Section
        );
        ...
        add_settings_field(
            ...
            __('Disable automatic redirects', 'wp-seopress-pro'), // Title
            [$this, 'seopress_404_disable_automatic_redirects_callback'], // Callback
            'seopress-settings-admin-monitor-404', // Page
            'seopress_setting_section_monitor_404' // Section
        );
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_htaccess'], // Callback
        ...
        add_settings_field(
           ...
           __('Edit your htaccess file', 'wp-seopress-pro'), // Title
            [$this, 'seopress_htaccess_file_callback'], // Callback
            'seopress-settings-admin-htaccess', // Page
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_rss'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rss_before_html_callback'], // Callback
            'seopress-settings-admin-rss', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rss_after_html_callback'], // Callback
            'seopress-settings-admin-rss', // Page
            'seopress_setting_section_rss' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rss_disable_comments_feed_callback'], // Callback
            'seopress-settings-admin-rss', // Page
            'seopress_setting_section_rss' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rss_disable_posts_feed_callback'], // Callback
            'seopress-settings-admin-rss', // Page
            'seopress_setting_section_rss' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rss_disable_extra_feed_callback'], // Callback
            'seopress-settings-admin-rss', // Page
            'seopress_setting_section_rss' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rss_disable_all_feeds_callback'], // Callback
            'seopress-settings-admin-rss', // Page
            'seopress_setting_section_rss' // Section
        );
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_google_analytics_dashboard'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_google_analytics_auth_callback'], // Callback
            'seopress-settings-admin-google-analytics-dashboard', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_google_analytics_auth_client_id_callback'], // Callback
            'seopress-settings-admin-google-analytics-dashboard', // Page
            'seopress_setting_section_google_analytics_dashboard' // Section
        );
        add_settings_field(
            ...
            [$this, 'seopress_google_analytics_auth_secret_id_callback'], // Callback
            'seopress-settings-admin-google-analytics-dashboard', // Page
            'seopress_setting_section_google_analytics_dashboard' // Section
        );
        add_settings_field(
            ...
            [$this, 'seopress_google_analytics_dashboard_widget_callback'], // Callback
            'seopress-settings-admin-google-analytics-dashboard', // Page
            'seopress_setting_section_google_analytics_dashboard' // Section
        );
        ...
        add_settings_section(
            ...
            '',
            //__("Analytics","wp-seopress-pro"), // Title
            [$this, 'print_section_info_google_analytics_ecommerce'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_google_analytics_purchases_callback'], // Callback
            'seopress-settings-admin-google-analytics-ecommerce', // Page
        ...
        add_settings_field(
            ...
            [$this, 'seopress_google_analytics_add_to_cart_callback'], // Callback
            'seopress-settings-admin-google-analytics-ecommerce', // Page
            'seopress_setting_section_google_analytics_ecommerce' // Section
        );
        add_settings_field(
            ...
            [$this, 'seopress_google_analytics_remove_from_cart_callback'], // Callback
            'seopress-settings-admin-google-analytics-ecommerce', // Page
            'seopress_setting_section_google_analytics_ecommerce' // Section
        );
        ...
        add_settings_field(
            ...
            [$this, 'seopress_advanced_security_metaboxe_sdt_role_callback'], // Callback
        ...
        add_settings_section(
            ...
            [$this, 'print_section_info_rewrite'], // Callback
        ...
        add_settings_field(
            ...
            [$this, 'seopress_rewrite_search_callback'], // Callback
            'seopress-settings-admin-rewrite', // Page
        ...
        if (is_network_admin() && is_multisite()) {
            add_settings_section(
                ...
                [$this, 'print_section_info_white_label'], // Callback
            ...
            add_settings_field(
                ...
                [$this, 'seopress_white_label_admin_header_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
            ...
            add_settings_field(
                ...
                [$this, 'seopress_white_label_admin_notices_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_white_label_admin_menu_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_white_label_footer_credits_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_white_label_help_links_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            ...
            add_settings_field(
                ...
                [$this, 'seopress_white_label_menu_pages_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            add_settings_field(
                ...
                [$this, 'seopress_white_label_plugin_list_title_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            add_settings_field(
                ...
                [$this, 'seopress_white_label_plugin_list_title_pro_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            add_settings_field(
                ...
                [$this, 'seopress_white_label_plugin_list_desc_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            add_settings_field(
                ...
                [$this, 'seopress_white_label_plugin_list_desc_pro_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            add_settings_field(
                ...
                [$this, 'seopress_white_label_plugin_list_author_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            add_settings_field(
                ...
                [$this, 'seopress_white_label_plugin_list_website_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
            add_settings_field(
                ...
                [$this, 'seopress_white_label_plugin_list_view_details_callback'], // Callback
                'seopress-mu-settings-admin-white-label', // Page
                'seopress_mu_setting_section_white_label' // Section
            );
        } else {
    ...
    public function print_pro_section($key) {
        ...
        if (function_exists('seopress_get_locale') && 'fr' == seopress_get_locale()) {
            $seopress_docs_link['lb']['eat'] = 'https://www.seopress.org/fr/blog/optimiser-site-wordpress-google-eat/?utm_source=plugin&utm_medium=wp-admin&utm_campaign=seopress';
        } else {
            $seopress_docs_link['lb']['eat'] = 'https://www.seopress.org/blog/optimizing-wordpress-sites-for-google-eat/?utm_source=plugin&utm_medium=wp-admin&utm_campaign=seopress';
        }
    ...
    public function print_section_info_bot() {
        ...
        echo '<a class="seopress-help" href="' . $seopress_docs_link['support']['bot'] . '" target="_blank"><span class="dashicons dashicons-info" title="' . __('Check our guide', 'wp-seopress-pro') . '"></span></a></p>';
    ...
    public function print_section_info_bot_settings() {
        echo __('<p>Broken links settings</p>', 'wp-seopress-pro');
    }
    ...
    public function print_section_info_news() {
        ...
        _e('To view your sitemap, enable permalinks (not default one), and save settings to flush them.', 'wp-seopress-pro');
        echo '<br>';
        _e('We respect the rules of Google News: Only articles published during the previous two days, and, to a limit of 1000 articles, are visible in the sitemap.', 'wp-seopress-pro');
        echo '<br>';
        echo '<br>';
    ...
    public function seopress_bot_scan_settings_where_callback() {
        ...
        $where = ['post_content' => __('Post content', 'wp-seopress-pro'), 'body_page' => __('Body page (extremely slow)', 'wp-seopress-pro')];
    ...
    public function seopress_bot_scan_settings_number_callback() {
        ...
        if ('1' == $check) {
            echo 'value="' . esc_attr($options['seopress_bot_scan_settings_number']) . '"';
        }
        echo ' value="100"/>';
    ...
    public function seopress_bot_scan_settings_timeout_callback() {
        ...
        if ('1' == $check) {
            echo 'value="' . esc_attr($options['seopress_bot_scan_settings_timeout']) . '"';
        }
        echo ' value="5"/>';
    ...
    public function seopress_local_business_street_address_callback() {
        ...
        echo '<p class="description">' . __('<span class="field-required"><strong>Required</strong></span> property by Google.', 'wp-seopress-pro') . '</p>';
    }
    ...
    public function seopress_local_business_lat_callback() {
        ...
        echo '<p class="description">' . __('<strong>Recommended</strong> property by Google.', 'wp-seopress-pro') . '</p>';
    }
    ...
    public function seopress_local_business_place_id_callback() {
        $check = isset($this->options['seopress_local_business_place_id']) ? $this->options['seopress_local_business_place_id'] : null;

        printf(
        '<input type="text" name="seopress_pro_option_name[seopress_local_business_place_id]" placeholder="' . esc_html__('eg: ChIJ1zmBfihrUQ0RE02R1pnXoc8', 'wp-seopress-pro') . '" aria-label="' . __('Google Maps Place ID', 'wp-seopress-pro') . '" value="%s" />',
        esc_html($check)
        );

        echo '<p class="description">' . __('<a href="https://developers.google.com/places/web-service/place-id" target="_blank">Click here to find your Google Maps Place ID</a><span class="seopress-help dashicons dashicons-external"></span> for your Local Business. <br>This ID will be used to display the Google Maps link from the LB widget.', 'wp-seopress-pro') . '</p>';
    }
        ...
        if (function_exists('wp_get_nav_menus')) {
            ...
            if ( ! empty($menus)) {
                foreach ($menus as $menu) {
                    echo ' <option ';
                    if (esc_attr($menu->term_id) == $selected) {
                        echo 'selected="selected"';
                    }
                    ...
                    if (function_exists('seopress_get_post_types')) {
                        ...
                        if ( ! empty($cpt)) {
                            foreach ($cpt as $post_type) {
                                ...
                                echo ' <option ';
                                if (esc_attr($post_type->name) == $selected) {
                                    echo 'selected="selected"';
                                }
                    ...
                    if (function_exists('seopress_get_taxonomies')) {
                        ...
                        if ( ! empty($tax)) {
                            foreach ($tax as $taxonomy) {
                                ...
                                echo ' <option ';
                                if (esc_attr($taxonomy->name) == $selected) {
                                    echo 'selected="selected"';
                                }
    ...
    public function seopress_breadcrumbs_i18n_here_callback() {
        $check = isset($this->options['seopress_breadcrumbs_i18n_here']) ? $this->options['seopress_breadcrumbs_i18n_here'] : null;
...
User-agent: SemrushBot-SA
    ...
    public function seopress_404_cleaning_callback() {
        ...
        echo '<p class="description">' . __('You must deactivate and reactivate the plugin to enable the scheduled task (CRON)', 'wp-seopress-pro') . '</p>';
    ...
    public function seopress_404_disable_automatic_redirects_callback() {
        $options = get_option('seopress_pro_option_name');

        $check = isset($options['seopress_404_disable_automatic_redirects']);

        echo '<input id="seopress_404_disable_automatic_redirects" name="seopress_pro_option_name[seopress_404_disable_automatic_redirects]" type="checkbox"';
        if ('1' == $check) {
            echo 'checked="yes"';
        }
        echo ' value="1"/>';

        echo '<label for="seopress_404_disable_automatic_redirects">' . __('Disable notifications on slug changes or post deletions', 'wp-seopress-pro') . '</label><br><br>';

        if (isset($this->options['seopress_404_disable_automatic_redirects'])) {
            esc_attr($this->options['seopress_404_disable_automatic_redirects']);
        }
    }
    ...
    public function seopress_white_label_admin_menu_callback() {
        if (is_network_admin() && is_multisite()) {
            ...
            echo '<input type="text" name="seopress_pro_mu_option_name[seopress_mu_white_label_admin_menu]" placeholder="' . esc_html__('Enter your dashicons CSS class name', 'wp-seopress-pro') . '" aria-label="' . __('CSS Dashicons class name without quotes', 'wp-seopress-pro') . '" value="' . esc_attr($check) . '" />';
        } else {
            $options = get_option('seopress_pro_option_name');
            $check   = isset($options['seopress_white_label_admin_menu']) ? esc_attr($options['seopress_white_label_admin_menu']) : null;

            echo '<input type="text" name="seopress_pro_option_name[seopress_white_label_admin_menu]" placeholder="' . esc_html__('Enter your dashicons CSS class name', 'wp-seopress-pro') . '" aria-label="' . __('CSS Dashicons class name without quotes', 'wp-seopress-pro') . '" value="' . esc_attr($check) . '" />';
        }
    ...
    public function seopress_google_analytics_dashboard_widget_callback() {
        $options = get_option('seopress_google_analytics_option_name');

        $check = isset($options['seopress_google_analytics_dashboard_widget']);

        echo '<input id="seopress_google_analytics_dashboard_widget" name="seopress_google_analytics_option_name[seopress_google_analytics_dashboard_widget]" type="checkbox"';
        if ('1' == $check) {
            echo 'checked="yes"';
        }
        echo ' value="1"/>';

        echo '<label for="seopress_google_analytics_dashboard_widget">' . __('Remove Google Analytics stats widget from WordPress dashboard', 'wp-seopress-pro') . '</label>';

        if (isset($this->options['seopress_google_analytics_dashboard_widget'])) {
            esc_attr($this->options['seopress_google_analytics_dashboard_widget']);
        }
    }
    ...
    public function seopress_advanced_security_metaboxe_sdt_role_callback() {
        ...
        foreach ($wp_roles->get_names() as $key => $value) {
            ...
            echo '<label for="seopress_advanced_security_metaboxe_sdt_role_' . $key . '"><strong>' . $value . '</strong> (<em>' . translate_user_role($value,  'default') . '</em>)' . '</label><br/>';
