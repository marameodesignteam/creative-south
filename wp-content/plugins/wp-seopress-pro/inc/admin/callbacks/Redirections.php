...
<label for="seopress_404_enable">
    <input id="seopress_404_enable" name="seopress_pro_option_name[seopress_404_enable]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<a
    ...
    <?php _e('View your 404 / 301', 'wp-seopress-pro'); ?>
</a>
...
<label for="seopress_404_cleaning">
    <input id="seopress_404_cleaning" name="seopress_pro_option_name[seopress_404_cleaning]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
...
<p class="description">
    <?php _e('You must deactivate and reactivate the plugin to enable the scheduled task (CRON)', 'wp-seopress-pro'); ?>
</p>
...
<label for="seopress_404_disable_automatic_redirects">
    <input id="seopress_404_disable_automatic_redirects"
        name="seopress_pro_option_name[seopress_404_disable_automatic_redirects]" type="checkbox" <?php if ('1' == $check) { ?>
    checked="yes"
    <?php } ?>
    value="1"/>
    ...
    <div class="inside">
        ...
        <div class="seopress-notice">
            ...
            <ul>
                ...
                <li>
                    <?php _e('type of redirection (301, 302 or 307, 410, 451),', 'wp-seopress-pro'); ?>
                </li>
                <li>
                ...
                <li>
                    <?php _e('and, the last parameter, category redirect IDs separated by commas (optional).', 'wp-seopress-pro'); ?>
                </li>
            </ul>
...
<div id="section-import-redirects-plugin" class="postbox section-tool">
    <div class="inside">
        ...
        <div class="seopress-notice">
            ...
            <p>
                <?php _e('Note that we do not support certain options, like regex.', 'wp-seopress-pro'); ?>
            </p>
            <p>
...
<div id="section-import-yoast-redirects" class="postbox section-tool">
    <div class="inside">
        ...
        <div class="seopress-notice">
            ...
            <p>
                <?php _e('Note that we don\'t support certain options, like regex.', 'wp-seopress-pro'); ?>
            </p>
            <p>
                <?php _e('To avoid conflicts, make sure there are no duplicates between your file and existing redirects.', 'wp-seopress-pro'); ?>
            </p>
...
<div id="section-clean-404" class="postbox section-tool">
    ...
    printf(__('You can also use <span class="dashicons dashicons-external"></span><a href="%s" target="_blank">this MySQL query</a> if necessary.', 'wp-seopress-pro'), $docs['redirects']['query']); ?>
        ...
        <form method="post">
            ...
            <?php sp_submit_button(__('Delete all 404', 'wp-seopress-pro'), 'btn btnSecondary'); ?>
        </form>
    </div><!-- .inside -->
</div><!-- .postbox -->
...
<div id="section-clean-redirects" class="postbox section-tool">
    <div class="inside">
        ...
        <form method="post">
            ...
            <?php sp_submit_button(__('Delete', 'wp-seopress-pro'), 'btn btnSecondary'); ?>
        </form>
    </div><!-- .inside -->
</div><!-- .postbox -->
<?php
