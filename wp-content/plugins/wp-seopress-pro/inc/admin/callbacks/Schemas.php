...
<input id="seopress_rich_snippets_publisher_logo_width" type="hidden" value="' . $options_set2 . '"
    name="seopress_pro_option_name[seopress_rich_snippets_publisher_logo_width]" />
<input id="seopress_rich_snippets_publisher_logo_height" type="hidden" value="' . $options_set3 . '"
...
<p>
    <img style="width:auto;height:auto;max-width:560px"
