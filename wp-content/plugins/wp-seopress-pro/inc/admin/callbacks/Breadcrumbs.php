...
<div class="wrap-tags">
    ...
    <button type="button" class="btn btnSecondary tag-title" id="seopress-tag-breadcrumbs-2" data-tag="–" class="tag-title"><?php _e('–', 'wp-seopress-pro'); ?></button>
    <button type="button" class="btn btnSecondary tag-title" id="seopress-tag-breadcrumbs-3" data-tag=">" class="tag-title"><?php _e('>', 'wp-seopress-pro'); ?></button>
    <button type="button" class="btn btnSecondary tag-title" id="seopress-tag-breadcrumbs-4" data-tag="<" class="tag-title"><?php _e('<', 'wp-seopress-pro'); ?></button>
    <button type="button" class="btn btnSecondary tag-title" id="seopress-tag-breadcrumbs-5" data-tag="|" class="tag-title"><?php _e('|', 'wp-seopress-pro'); ?></button>
</div>
...
<select id="seopress_breadcrumbs_cpt"
    ...
    <?php if (function_exists('seopress_get_post_types')) {
...
<select id="seopress_breadcrumbs_tax"
    ...
    <?php if (function_exists('seopress_get_taxonomies')) {
                $tax = seopress_get_taxonomies();
