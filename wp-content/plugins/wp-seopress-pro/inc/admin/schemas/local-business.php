...
function seopress_get_schema_metaboxe_local_business($seopress_pro_rich_snippets_data, $key_schema = 0) {
	...
	<div class="wrap-rich-snippets-item wrap-rich-snippets-local-business">
		...
		<p>
			...
			<input type="text" id="seopress_pro_rich_snippets_lb_menu_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_lb_menu]" placeholder="<?php echo sprintf(esc_html__('eg: %s', 'wp-seopress-pro'), get_home_url()); ?>" aria-label="<?php _e('The URL of the menu.', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_lb_menu; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_lb_accepts_reservations_meta">
				<?php _e('Accepts reservations', 'wp-seopress-pro'); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_lb_accepts_reservations_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_lb_accepts_reservations]" placeholder="<?php echo esc_html__('eg: True', 'wp-seopress-pro'); ?>" aria-label="<?php _e('Accepts reservations ', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_lb_accepts_reservations; ?>" />
                ...
                echo 'checked="yes"';
							...
							>
								...
								<?php foreach ($hours as $hour) { ?>
									<option
										<?php if ($hour == $selected_start_hours) {
							...
							>
								...
								<?php foreach ($mins as $min) { ?>
									<option
										<?php if ($min == $selected_start_mins) {
                                echo 'selected="selected"';
                            } ?>
							...
							<?php foreach ($hours as $hour) { ?>
								<option
									<?php if ($hour == $selected_end_hours) {
                                echo 'selected="selected"';
                            } ?>
									value="<?php echo $hour; ?>"
								>
					...
					<li>
						...
						>
							...
							<?php foreach ($hours as $hour) { ?>
								<option
									<?php if ($hour == $selected_start_hours2) {
                            echo 'selected="selected"';
                        } ?>
									value="<?php echo $hour; ?>"
								>
						...
						>
							<?php foreach ($mins as $min) { ?>
								<option
									<?php if ($min == $selected_start_mins2) {
                            echo 'selected="selected"';
                        } ?>
									value="<?php echo $min; ?>"
								>
						...
						>
							...
							<?php foreach ($hours as $hour) { ?>
								<option
									<?php if ($hour == $selected_end_hours2) {
                            echo 'selected="selected"';
                        } ?>
									value="<?php echo $hour; ?>">
									<?php echo $hour; ?>
