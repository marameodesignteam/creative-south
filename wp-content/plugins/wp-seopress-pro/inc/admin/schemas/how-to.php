...
function seopress_get_schema_metaboxe_how_to($seopress_pro_rich_snippets_data, $key_schema = 0) {
    ...
    <div class="wrap-rich-snippets-item wrap-rich-snippets-how-to">
        ...
        <p>
			...
			<input type="text" id="seopress_pro_rich_snippets_how_to_name_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_name]" placeholder="<?php echo esc_html__('The name of your how-to', 'wp-seopress-pro'); ?>" aria-label="<?php _e('How-to name', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_how_to_name; ?>" />
		</p>
        ...
        <p>
			...
			<textarea id="seopress_pro_rich_snippets_how_to_desc" style="width:100%" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_desc]" placeholder="<?php echo esc_html__('Enter your how-to description', 'wp-seopress-pro'); ?>" aria-label="<?php _e('How-to description', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_how_to_desc; ?>"><?php echo $seopress_pro_rich_snippets_how_to_desc; ?></textarea>
		</p>
		...
		<p>
            ...
            <!-- URL -->
            <input id="seopress_pro_rich_snippets_how_to_img_meta" type="text" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_img]" placeholder="<?php echo esc_html__('Select your image', 'wp-seopress-pro'); ?>" aria-label="<?php _e('Image thumbnail', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_how_to_img; ?>" />

            <!-- Width -->
            <input id="seopress_pro_rich_snippets_how_to_img_width" type="hidden" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_img_width]" value="<?php echo $seopress_pro_rich_snippets_how_to_img_width; ?>" />

            <!-- Height -->
            <input id="seopress_pro_rich_snippets_how_to_img_height" type="hidden" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_img_height]" value="<?php echo $seopress_pro_rich_snippets_how_to_img_height; ?>" />

            <!-- Upload -->
            <input id="seopress_pro_rich_snippets_how_to_img" class="button seopress_media_upload" type="button" value="<?php _e('Upload an Image', 'wp-seopress-pro'); ?>" />
		</p>
        ...
        <p>
			...
			<input type="text" id="seopress_pro_rich_snippets_how_to_cost_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_cost]" placeholder="<?php echo esc_html__('The estimated cost', 'wp-seopress-pro'); ?>" aria-label="<?php _e('How-to estimated cost', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_how_to_cost; ?>" />
		</p>
        ...
        <p>
			...
			<input type="text" id="seopress_pro_rich_snippets_how_to_currency_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_currency]" placeholder="<?php echo esc_html__('The currency of the estimated cost', 'wp-seopress-pro'); ?>" aria-label="<?php _e('How-to currency', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_how_to_currency; ?>" />
		</p>
        ...
        <p>
			...
			<input type="text" id="seopress_pro_rich_snippets_how_to_total_time_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to_total_time]" placeholder="<?php echo esc_html__('Eg: HH:MM:SS', 'wp-seopress-pro'); ?>" aria-label="<?php _e('Total time needed', 'wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_how_to_total_time; ?>" />
		</p>
    ...
    if ($total > 0) {
        ?>
            ...
            $check_img  = isset($seopress_pro_rich_snippets_how_to[0][$key]['img']) ? esc_textarea($seopress_pro_rich_snippets_how_to[0][$key]['img']) : null; ?>
				<div class="step">
					...
					<div class="accordion-section-content">
						<div class="inside">
							<p>
								<label for="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to][<?php echo $key; ?>][name]">
							...
							<p>
								<label for="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to][<?php echo $key; ?>][text]">
								...
								<textarea
									...
									value="<?php echo $check_text; ?>" rows="8"><?php echo $check_text; ?></textarea>
							</p>
			...
			<div id="wrap-how-to" data-count="1">
				<div class="step">
					...
					<div class="accordion-section-content">
						<div class="inside">
							<p>
								<label for="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to][0][name]">
									<?php _e('The title of the step (required)', 'wp-seopress-pro'); ?>
								</label>
								<input
									...
									placeholder="<?php echo esc_html__('Enter a title for this step', 'wp-seopress-pro'); ?>"
									aria-label="<?php _e('Step name', 'wp-seopress-pro'); ?>" value=""
								/>
							</p>

							<p>
								<label for="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_how_to][0][text]">
									<?php _e('The text of your step (required)', 'wp-seopress-pro'); ?>
								</label>
								<textarea
		...
		<?php } ?>
		<p><a href="#" id="add-step" class="add-step button button-primary"><?php _e('Add step', 'wp-seopress-pro'); ?></a></p>
	</div>
	<?php
}
