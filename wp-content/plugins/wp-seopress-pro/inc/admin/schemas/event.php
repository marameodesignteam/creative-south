...
function seopress_get_schema_metaboxe_event($seopress_pro_rich_snippets_data, $key_schema = 0){
	...
	<div class="wrap-rich-snippets-item wrap-rich-snippets-events">
		...
		<ul class="advice seopress-list notice notice-info">
			<li>
		...
		<p>
			...
			<select id="seopress_pro_rich_snippets_events_type_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_type]">
				<option <?php selected( 'BusinessEvent', $seopress_pro_rich_snippets_events_type); ?> value="BusinessEvent"><?php _e( 'Business Event', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'ChildrensEvent', $seopress_pro_rich_snippets_events_type); ?> value="ChildrensEvent">
					<?php _e( 'Children\'s Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'ComedyEvent', $seopress_pro_rich_snippets_events_type); ?> value="ComedyEvent">
					<?php _e( 'Comedy Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'CourseInstance', $seopress_pro_rich_snippets_events_type); ?> value="CourseInstance">
					<?php _e( 'Course Instance', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'DanceEvent', $seopress_pro_rich_snippets_events_type); ?> value="DanceEvent">
					<?php _e( 'Dance Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'DeliveryEvent', $seopress_pro_rich_snippets_events_type); ?> value="DeliveryEvent">
					<?php _e( 'Delivery Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'EducationEvent', $seopress_pro_rich_snippets_events_type); ?> value="EducationEvent">
					<?php _e( 'Education Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'ExhibitionEvent', $seopress_pro_rich_snippets_events_type); ?> value="ExhibitionEvent">
					<?php _e( 'Exhibition Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'Festival', $seopress_pro_rich_snippets_events_type); ?> value="Festival">
					<?php _e( 'Festival', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'FoodEvent', $seopress_pro_rich_snippets_events_type); ?> value="FoodEvent">
					<?php _e( 'Food Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'LiteraryEvent', $seopress_pro_rich_snippets_events_type); ?> value="LiteraryEvent">
					<?php _e( 'Literary Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'MusicEvent', $seopress_pro_rich_snippets_events_type); ?> value="MusicEvent">
					<?php _e( 'Music Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'PublicationEvent', $seopress_pro_rich_snippets_events_type); ?> value="PublicationEvent">
					<?php _e( 'Publication Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'SaleEvent', $seopress_pro_rich_snippets_events_type); ?> value="SaleEvent">
					<?php _e( 'Sale Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'ScreeningEvent', $seopress_pro_rich_snippets_events_type); ?> value="ScreeningEvent">
					<?php _e( 'Screening Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'SocialEvent', $seopress_pro_rich_snippets_events_type); ?> value="SocialEvent">
					<?php _e( 'Social Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'SportsEvent', $seopress_pro_rich_snippets_events_type); ?> value="SportsEvent">
					<?php _e( 'Sports Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'TheaterEvent', $seopress_pro_rich_snippets_events_type); ?> value="TheaterEvent">
					<?php _e( 'Theater Event', 'wp-seopress-pro' ); ?>
				</option>
				<option <?php selected( 'VisualArtsEvent', $seopress_pro_rich_snippets_events_type); ?> value="VisualArtsEvent">
		...
		<p>
			...
			<input type="text" id="seopress_pro_rich_snippets_events_name_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_name]" placeholder="<?php echo esc_html__('The name of your event','wp-seopress-pro'); ?>" aria-label="<?php _e('Event name','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_name; ?>" />
		</p>
		<p>
			...
			<textarea id="seopress_pro_rich_snippets_events_desc" style="width:100%" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_desc]" placeholder="<?php echo esc_html__('Enter your event description','wp-seopress-pro'); ?>" aria-label="<?php _e('Event description','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_desc; ?>"><?php echo $seopress_pro_rich_snippets_events_desc; ?></textarea>
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_img_meta">
				<?php _e( 'Image thumbnail', 'wp-seopress-pro' ); ?>
			</label>
			<span class="advise"><?php _e('Minimum width: 720px - Recommended size: 1920px -  .jpg, .png, or. gif format - crawlable and indexable', 'wp-seopress-pro'); ?></span>
			<input id="seopress_pro_rich_snippets_events_img_meta" type="text" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_img]" placeholder="<?php echo esc_html__('Select your image','wp-seopress-pro'); ?>" aria-label="<?php _e('Image thumbnail','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_img; ?>" />
			<input id="seopress_pro_rich_snippets_events_img" class="button seopress_media_upload" type="button" value="<?php _e('Upload an Image','wp-seopress-pro'); ?>" />
		</p>
		<p>
		...
		<p>
			...
			<input type="text" id="seopress_pro_rich_snippets_events_start_time_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_start_time]" placeholder="<?php echo esc_html__('Eg: HH:MM','wp-seopress-pro'); ?>" aria-label="<?php _e('Start time','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_start_time; ?>" />
		</p>
		<p>
			<label for="seopress-date-picker2">
				<?php _e( 'End date', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress-date-picker2" class="seopress-date-picker" autocomplete="off" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_end_date]" placeholder="<?php echo esc_html__('Eg: YYYY-MM-DD','wp-seopress-pro'); ?>" aria-label="<?php _e('End date','wp-seopress-pro'); ?>"  value="<?php echo $seopress_pro_rich_snippets_events_end_date; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_end_time_meta">
				<?php _e( 'End time', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_events_end_time_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_end_time]" placeholder="<?php echo esc_html__('Eg: HH:MM','wp-seopress-pro'); ?>" aria-label="<?php _e('End time','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_end_time; ?>" />
		</p>
		<p>
			<label for="seopress-date-picker7">
				<?php _e( 'Previous start date', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress-date-picker7" class="seopress-date-picker" autocomplete="off" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_previous_start_date]" placeholder="<?php echo esc_html__('Eg: YYYY-MM-DD','wp-seopress-pro'); ?>" aria-label="<?php _e('Previous start date','wp-seopress-pro'); ?>"  value="<?php echo $seopress_pro_rich_snippets_events_previous_start_date; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_previous_start_time_meta">
				<?php _e( 'Previous start time', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_events_previous_start_time_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_previous_start_time]" placeholder="<?php echo esc_html__('Eg: HH:MM','wp-seopress-pro'); ?>" aria-label="<?php _e('Previous start time','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_previous_start_time; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_location_name_meta">
				<?php _e( 'Location name', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_events_location_name_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_location_name]" placeholder="<?php echo esc_html__('Eg: Hotel du Palais','wp-seopress-pro'); ?>" aria-label="<?php _e('Location name','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_location_name; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_location_url_meta">
				<?php _e( 'Location Website', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_events_location_url_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_location_url]" placeholder="<?php echo esc_html__('Eg: http://www.hotel-du-palais.com/','wp-seopress-pro'); ?>" aria-label="<?php _e('Location Website','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_location_url; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_location_address_meta">
				<?php _e( 'Location Address', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_events_location_address_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_location_address]" placeholder="<?php echo esc_html__('Eg: 1 Avenue de l\'Imperatrice, 64200 Biarritz','wp-seopress-pro'); ?>" aria-label="<?php _e('Location Address','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_location_address; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_offers_name_meta">
				<?php _e( 'Offer name', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_events_offers_name_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_name]" aria-label="<?php _e('Offer name','wp-seopress-pro'); ?>" placeholder="<?php echo esc_html__('Eg: General admission','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_offers_name; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_offers_cat_meta"><?php _e( 'Select your offer category', 'wp-seopress-pro' ); ?>
		</label>
			<select id="seopress_pro_rich_snippets_events_offers_cat_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_cat]">
				<option <?php selected( 'Primary', $seopress_pro_rich_snippets_events_offers_cat); ?> value="Primary"><?php _e( 'Primary', 'wp-seopress-pro' ) ; ?></option>
				<option <?php selected( 'Secondary', $seopress_pro_rich_snippets_events_offers_cat); ?> value="Secondary"><?php _e( 'Secondary', 'wp-seopress-pro' ) ; ?></option>
				<option <?php selected( 'Presale', $seopress_pro_rich_snippets_events_offers_cat); ?> value="Presale"><?php _e( 'Presale', 'wp-seopress-pro' ) ; ?></option>
				<option <?php selected( 'Premium', $seopress_pro_rich_snippets_events_offers_cat); ?> value="Premium"><?php _e( 'Premium', 'wp-seopress-pro' ) ; ?></option>
			</select>
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_offers_price_meta">
				...
				<p><?php _e('The lowest available price, including service charges and fees, of this type of ticket.','wp-seopress-pro'); ?></p>
			<input type="text" id="seopress_pro_rich_snippets_events_offers_price_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_price]" placeholder="<?php echo esc_html__('Eg: 10','wp-seopress-pro'); ?>" aria-label="<?php _e('Price','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_offers_price; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_offers_price_currency_meta"><?php _e( 'Select your currency', 'wp-seopress-pro' ); ?>
		</label>
			<select id="seopress_pro_rich_snippets_events_offers_price_currency_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_price_currency]">
				<?php foreach($options_currencies as $item): ?>
					<option <?php selected( $item['value'], $seopress_pro_rich_snippets_events_offers_price_currency); ?> value="<?php echo $item["value"]; ?>">
						 <?php echo $item["label"]; ?>
					</option>
				<?php endforeach; ?>
			</select>
		...
		<p>
			...
			<select id="seopress_pro_rich_snippets_events_offers_availability_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_availability]">
				<option <?php selected( 'InStock', $seopress_pro_rich_snippets_events_offers_availability); ?> value="InStock"><?php _e( 'In Stock', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'SoldOut', $seopress_pro_rich_snippets_events_offers_availability); ?> value="SoldOut"><?php _e( 'Sold Out', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'PreOrder', $seopress_pro_rich_snippets_events_offers_availability); ?> value="PreOrder"><?php _e( 'Pre Order', 'wp-seopress-pro' ); ?></option>
			</select>
		</p>
		<p>
			...
			<input type="text" id="seopress-date-picker3" class="seopress-date-picker" autocomplete="off" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_valid_from_date]" aria-label="<?php _e('The date when tickets go on sale','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_offers_valid_from_date; ?>" />
			<label for="seopress_pro_rich_snippets_events_offers_valid_from_meta_time">
				<?php _e( 'Time', 'wp-seopress-pro' ); ?>
			</label>
			<?php _e('The time when tickets go on sale','wp-seopress-pro'); ?>
			<input type="time" id="seopress_pro_rich_snippets_events_offers_valid_from_meta_time" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_valid_from_time]" aria-label="<?php _e('The time when tickets go on sale','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_offers_valid_from_time; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_events_offers_url_meta">
				<?php _e( 'Website to buy tickets', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_events_offers_url_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_offers_url]" placeholder="<?php echo esc_html__('Eg: https://fnac.com/','wp-seopress-pro'); ?>" aria-label="<?php _e('Website to buy tickets','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_events_offers_url; ?>" />
		</p>
		<p>
		...
		<p>
			...
			<select id="seopress_pro_rich_snippets_events_status_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_status]">
				<option <?php selected( 'none', $seopress_pro_rich_snippets_events_status); ?>  value="none"><?php _e( 'Select a status event', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'EventCancelled', $seopress_pro_rich_snippets_events_status); ?>  value="EventCancelled"><?php _e( 'Event cancelled', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'EventMovedOnline', $seopress_pro_rich_snippets_events_status); ?>  value="EventMovedOnline"><?php _e( 'Event moved online', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'EventPostponed', $seopress_pro_rich_snippets_events_status); ?>  value="EventPostponed"><?php _e( 'Event postponed', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'EventRescheduled', $seopress_pro_rich_snippets_events_status); ?>  value="EventRescheduled"><?php _e( 'Event rescheduled', 'wp-seopress-pro' ); ?></option>
				<option <?php selected( 'EventScheduled', $seopress_pro_rich_snippets_events_status); ?>  value="EventScheduled"><?php _e( 'Event scheduled', 'wp-seopress-pro' ); ?></option>
			</select>
		</p>
		<p>
			...
			<select id="seopress_pro_rich_snippets_events_attendance_mode_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_events_attendance_mode]">
				<option <?php selected( 'none', $seopress_pro_rich_snippets_events_attendance_mode); ?> value="none"><?php _e( 'Select your event attendance mode', 'wp-seopress-pro' ) ; ?></option>
				<option <?php selected( 'OfflineEventAttendanceMode', $seopress_pro_rich_snippets_events_attendance_mode); ?> value="OfflineEventAttendanceMode"><?php _e( 'Offline event', 'wp-seopress-pro' ) ; ?></option>
				<option <?php selected( 'OnlineEventAttendanceMode', $seopress_pro_rich_snippets_events_attendance_mode); ?> value="OnlineEventAttendanceMode"><?php _e( 'Online event', 'wp-seopress-pro' ) ; ?></option>
				<option <?php selected( 'MixedEventAttendanceMode', $seopress_pro_rich_snippets_events_attendance_mode); ?> value="MixedEventAttendanceMode"><?php _e( 'Mixed event', 'wp-seopress-pro' ) ; ?></option>
			</select>
		</p>
	</div>
	<?php
