...
function seopress_get_schema_metaboxe_service($seopress_pro_rich_snippets_data, $key_schema = 0) {
	...
	<div class="wrap-rich-snippets-item wrap-rich-snippets-services">
		...
		<p>
			...
			<input type="text" id="seopress_pro_rich_snippets_service_name_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_name]" placeholder="<?php echo esc_html__('The name of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Service name','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_name; ?>" />
		...
		<p>
			...
			<input type="text" id="seopress_pro_rich_snippets_service_type_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_type]" placeholder="<?php echo esc_html__('The type of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Service type','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_type; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_description_meta">
				<?php _e( 'Service description', 'wp-seopress-pro' ); ?>
			</label>
			<textarea style="width:100%" id="seopress_pro_rich_snippets_service_description_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_description]" placeholder="<?php echo esc_html__('The description of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Service description','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_description; ?>" ><?php echo $seopress_pro_rich_snippets_service_description; ?></textarea>
		...
		<p>
			...
			<input id="seopress_pro_rich_snippets_service_img_meta" type="text" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_img]" placeholder="<?php echo esc_html__('Select your image','wp-seopress-pro'); ?>" aria-label="<?php _e('Thumbnail','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_img; ?>" />
			<span class="description"><?php _e('Default: post thumbnail','wp-seopress-pro'); ?></span>
			<input id="seopress_pro_rich_snippets_service_img" class="button seopress_media_upload" type="button" value="<?php _e('Upload an Image','wp-seopress-pro'); ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_area_meta">
				<?php _e( 'Area served', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_area_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_area]" placeholder="<?php echo esc_html__('The area served by your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Area served','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_area; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_provider_name_meta">
				<?php _e( 'Provider name', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_provider_name_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_provider_name]" placeholder="<?php echo esc_html__('The provider name of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Provider name','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_provider_name; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_lb_img_meta"><?php _e( 'Location image', 'wp-seopress-pro' ); ?>
		</label>
			<input id="seopress_pro_rich_snippets_service_lb_img_meta" type="text" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_lb_img]" placeholder="<?php echo esc_html__('Select your location image','wp-seopress-pro'); ?>" aria-label="<?php _e('Location image','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_lb_img; ?>" />
			<input id="seopress_pro_rich_snippets_service_lb_img" class="button seopress_media_upload" type="button" value="<?php _e('Upload an Image','wp-seopress-pro'); ?>" />
		</p>
		<p>
			...
			<input type="text" id="seopress_pro_rich_snippets_service_provider_mobility_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_provider_mobility]" placeholder="<?php echo esc_html__('The provider mobility of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Provider mobility','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_provider_mobility; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_slogan_meta">
				<?php _e( 'Slogan', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_slogan_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_slogan]" placeholder="<?php echo esc_html__('The slogan of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Slogan','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_slogan; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_street_addr_meta">
				<?php _e( 'Street Address', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_street_addr_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_street_addr]" placeholder="<?php echo esc_html__('The street address of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Street Address','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_street_addr; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_city_meta">
				<?php _e( 'City', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_city_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_city]" placeholder="<?php echo esc_html__('The city of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('City','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_city; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_state_meta">
				<?php _e( 'State', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_state_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_state]" placeholder="<?php echo esc_html__('The state of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('State','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_state; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_pc_meta">
				<?php _e( 'Postal code', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_pc_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_pc]" placeholder="<?php echo esc_html__('The postal code of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Postal code','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_pc; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_country_meta">
				<?php _e( 'Country', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_country_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_country]" placeholder="<?php echo esc_html__('The country of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Country','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_country; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_lat_meta">
				<?php _e( 'Latitude', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_lat_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_lat]" placeholder="<?php echo esc_html__('The latitude of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Latitude','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_lat; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_lon_meta">
				<?php _e( 'Longitude', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_lon_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_lon]" placeholder="<?php echo esc_html__('The longitude of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Longitude','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_lon; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_tel_meta">
				<?php _e( 'Telephone', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_tel_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_tel]" placeholder="<?php echo esc_html__('The telephone of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Telephone','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_tel; ?>" />
		</p>
		<p>
			<label for="seopress_pro_rich_snippets_service_price_meta">
				<?php _e( 'Price range', 'wp-seopress-pro' ); ?>
			</label>
			<input type="text" id="seopress_pro_rich_snippets_service_price_meta" name="seopress_pro_rich_snippets_data[<?php echo $key_schema; ?>][seopress_pro_rich_snippets_service_price]" placeholder="<?php echo esc_html__('The price range of your service','wp-seopress-pro'); ?>" aria-label="<?php _e('Price range','wp-seopress-pro'); ?>" value="<?php echo $seopress_pro_rich_snippets_service_price; ?>" />
		</p>
	</div>
	<?php
}
