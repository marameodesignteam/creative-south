...
class Local_Business_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        if ( ! empty($street) || ! empty($city) || ! empty($code) || ! empty($state) || ! empty($country) || ( ! empty($map) && '1' != $map && '' != $map) || ! empty($phone)) {
            echo '<p>';
        }
                    ...
                    if ( ! empty($days['open']) && '1' == $days['open']) {
                        ...
                        foreach ($days as $keyHalfDay => $valueHalfDay) {
                            ...
                            if ( ! empty($valueHalfDay['start']) && isset($valueHalfDay['open']) && '1' === $valueHalfDay['open']) {
                                echo $valueHalfDay['start']['hours'];
                                _e(':', 'wp-seopress-pro');
                                echo $valueHalfDay['start']['mins'];
                            }
                            if ( ! empty($valueHalfDay['end']) && isset($valueHalfDay['open']) && '1' === $valueHalfDay['open']) {
                                _e(' - ', 'wp-seopress-pro');
                                echo $valueHalfDay['end']['hours'];
                                _e(':', 'wp-seopress-pro');
                                echo $valueHalfDay['end']['mins'];
                            }
    ...
    public function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_name('street'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('street'); ?>" name="<?php echo $this->get_field_name('street'); ?>" type="checkbox" <?php if ('1' == $street) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('city'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('city'); ?>" name="<?php echo $this->get_field_name('city'); ?>" type="checkbox" <?php if ('1' == $city) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('state'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('state'); ?>" name="<?php echo $this->get_field_name('state'); ?>" type="checkbox" <?php if ('1' == $state) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('code'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('code'); ?>" name="<?php echo $this->get_field_name('code'); ?>" type="checkbox" <?php if ('1' == $code) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('country'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('country'); ?>" name="<?php echo $this->get_field_name('country'); ?>" type="checkbox" <?php if ('1' == $country) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('map'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('map'); ?>" name="<?php echo $this->get_field_name('map'); ?>" type="checkbox" <?php if ('1' == $map) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('phone'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('phone'); ?>" name="<?php echo $this->get_field_name('phone'); ?>" type="checkbox" <?php if ('1' == $phone) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('opening_hours'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('opening_hours'); ?>" name="<?php echo $this->get_field_name('opening_hours'); ?>" type="checkbox" <?php if ('1' == $opening_hours) {
                echo 'checked="yes"';
            } ?> value="1"/>
		...
		<p>
			<label for="<?php echo $this->get_field_name('hide_opening_hours'); ?>">
				<input class="widefat" id="<?php echo $this->get_field_name('hide_opening_hours'); ?>" name="<?php echo $this->get_field_name('hide_opening_hours'); ?>" type="checkbox" <?php if ('1' == $hide_opening_hours) {
                echo 'checked="yes"';
            } ?> value="1"/>
