...
class ActionScheduler_WPCommentCleaner {
     ...
     *
     * @return bool whether there are scheduled action comments in the comments table
     */
    ...
    public static function maybe_schedule_cleanup() {
        if ((bool) get_comments(['type' => ActionScheduler_wpCommentLogger::TYPE, 'number' => 1, 'fields' => 'ids'])) {
    ...
    public static function delete_all_action_comments() {
        global $wpdb;
        $wpdb->delete($wpdb->comments, ['comment_type' => ActionScheduler_wpCommentLogger::TYPE, 'comment_agent' => ActionScheduler_wpCommentLogger::AGENT]);
