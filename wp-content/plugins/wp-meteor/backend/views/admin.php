        ...
        <div id="tabs" class="settings-tab">
            ...
            <div id="how-it-works" class="tab">
                <div>
                    <!--
                    <p>
                        There are multiple variables, that affect your page score, here are the most important ones:
                        <ol>
                            <li>Amount of data, transferred from network - HTML, CSS, images, scripts</li>
                            <li>Latency of the data sources - server's CPU and network speed</li>
                            <li>Your visitor's device performance - how long does it take to initially render the page </li>
                        </ol>
                    </p>
                    -->
                    <p>
