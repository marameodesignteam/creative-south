...
!function(i){i(window).width();0<i(".facet-search").length&&i(".facet-search").offset().top,i(window).on("load",function(){function a(){i(".mega-indicator-button").attr("aria-expanded","false"),i(".sub-menu").hide(),i(".menu-item-has-children").removeClass("active")}var t,o;i("#mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-item > a.mega-menu-link").removeAttr("aria-expanded"),i('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){var a,t,o;location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname&&(o=i(this.hash),a=i("#masthead").outerHeight(),(o=o.length?o:i("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),t=o.offset().top-a-20,i("html, body").animate({scrollTop:t},600)))}),function(){var e=window.location.hash,a=i("#masthead").outerHeight();{var t,o;!e||(t=i(e)).length&&(o=t.offset().top,jQuery("html, body").animate({scrollTop:o-a-20},600))}}(),i("#menu-primary-menu > li.menu-item-has-children > a, #menu-primary-menu > li.menu-item-has-children li.menu-item-has-children > a").each(function(){i(this).unbind(),i(this).removeAttr("aria-expanded"),i(this).removeAttr("aria-haspopup");var e=i(this).next(),a=i(this).closest("li"),t=a.attr("id");e.attr("id",t+"_ul");var o=i("<button class='mega-indicator mega-indicator-button top-level d-xl-none'><span class='sr-only'>"+i(this).text()+" submenu</span></button>");o.attr("aria-controls",t+"_ul"),o.attr("aria-expanded","false"),o.insertAfter(i(this)),a.addClass("mega-with-button"),i(this).find(".mega-indicator:not(.mega-indicator-button)").remove(),a.addClass("js")}),i("body").on("click",".mega-indicator-button",function(){i(this).parent("li").toggleClass("active"),"false"==i(this).attr("aria-expanded")?i(this).attr("aria-expanded","true"):i(this).attr("aria-expanded","false"),i(this).next(".sub-menu").slideToggle()}),i(".menu-toggle").on("click",function(){var e=i("#menu-mobile");e.hasClass("open")?(e.removeClass("open"),i("body").removeClass("open"),i(this).attr("aria-expanded","false"),i("html,body").removeClass("hidden")):(e.addClass("open"),i("body").addClass("open"),i(this).attr("aria-expanded","true"),i("html,body").addClass("hidden")),a()}),i(".overlay").on("click",function(){i("#menu-mobile").removeClass("open"),i("html,body").removeClass("hidden"),a(),i("body").removeClass("open")}),t=i("<input>"),o=i(location).attr("href"),i(".clipboard").on("click",function(e){e.preventDefault(),i("body").append(t),t.val(o).select(),document.execCommand("copy"),t.remove(),i(".copied").addClass("active"),setTimeout(function(){i(".copied").removeClass("active")},2e3)})}),i(document).ready(function(e){e(".post-list .description .read-more").remove(),e("#wellcomeModal").modal("show"),i(".js-search-form").on("click",function(){i("#search-form").addClass("active")}),i(".bg-searchform").on("click",function(){i("#search-form").removeClass("active")}),0<e("body").find(".carousel-blocks").length?e(".entry-header .entry-title").addClass("sr-only"):(e(".site-header .custom-fixed-header").addClass("no-fixed"),e(".the-header").addClass("active"),e(".entry-header .entry-title").addClass("show"))}),i(window).resize(function(){i(window).width()}),i(window).scroll(function(){var e;e=i("body").find(".carousel-blocks"),console.log(e),0<e.length?i(window).scrollTop()>i(".site-header").offset().top?i(".custom-fixed-header").addClass("fixed"):i(".custom-fixed-header").removeClass("fixed"):i(window).scrollTop()>i(".site-header").offset().top?i(".custom-fixed-header").addClass("fixed").removeClass("no-fixed"):i(".custom-fixed-header").removeClass("fixed").addClass("no-fixed")});var e=i(".full-height"),a=i(".the-header").height();console.log(a);var t=i(window).height()-112.4-41;console.log(t),e.height(t)}(jQuery);