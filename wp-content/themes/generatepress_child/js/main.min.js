...
!function(o){o(window).width();0<o(".facet-search").length&&o(".facet-search").offset().top,o(window).on("load",function(){function a(){o(".mega-indicator-button").attr("aria-expanded","false"),o(".sub-menu").hide(),o(".menu-item-has-children").removeClass("active")}o("#mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-item > a.mega-menu-link").removeAttr("aria-expanded"),o('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){var a,t,n;location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname&&(n=o(this.hash),a=o("#masthead").outerHeight(),(n=n.length?n:o("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),t=n.offset().top-a-20,o("html, body").animate({scrollTop:t},600)))}),function(){var e=window.location.hash,a=o("#masthead").outerHeight();{var t,n;!e||(t=o(e)).length&&(n=t.offset().top,jQuery("html, body").animate({scrollTop:n-a-20},600))}}(),o("#menu-primary-menu > li.menu-item-has-children > a, #menu-primary-menu > li.menu-item-has-children li.menu-item-has-children > a").each(function(){o(this).unbind(),o(this).removeAttr("aria-expanded"),o(this).removeAttr("aria-haspopup");var e=o(this).next(),a=o(this).closest("li"),t=a.attr("id");e.attr("id",t+"_ul");var n=o("<button class='mega-indicator mega-indicator-button top-level d-xl-none'><span class='sr-only'>"+o(this).text()+" submenu</span></button>");n.attr("aria-controls",t+"_ul"),n.attr("aria-expanded","false"),n.insertAfter(o(this)),a.addClass("mega-with-button"),o(this).find(".mega-indicator:not(.mega-indicator-button)").remove(),a.addClass("js")}),o("body").on("click",".mega-indicator-button",function(){o(this).parent("li").toggleClass("active"),"false"==o(this).attr("aria-expanded")?o(this).attr("aria-expanded","true"):o(this).attr("aria-expanded","false"),o(this).next(".sub-menu").slideToggle()}),o(".menu-toggle").on("click",function(){var e=o("#menu-mobile");e.hasClass("open")?(e.removeClass("open"),o("body").removeClass("open"),o(this).attr("aria-expanded","false"),o("html,body").removeClass("hidden")):(e.addClass("open"),o("body").addClass("open"),o(this).attr("aria-expanded","true"),o("html,body").addClass("hidden")),a()}),o(".overlay").on("click",function(){o("#menu-mobile").removeClass("open"),o("html,body").removeClass("hidden"),a(),o("body").removeClass("open")})}),o(document).ready(function(e){e(".post-list .description .read-more").remove(),e("#wellcomeModal").modal("show"),o(".js-search-form").on("click",function(){o("#search-form").addClass("active")}),o(".bg-searchform").on("click",function(){o("#search-form").removeClass("active")})}),o(window).resize(function(){o(window).width()}),o(window).scroll(function(){o(window).scrollTop()>o(".site-header").offset().top?o(".custom-fixed-header").addClass("fixed"):o(".custom-fixed-header").removeClass("fixed")})}(jQuery);