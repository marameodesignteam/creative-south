...
!function(s){var o=s(window).width();0<s(".facet-search").length&&s(".facet-search").offset().top,s(window).on("load",function(){function a(){s(".mega-indicator-button").attr("aria-expanded","false"),s(".sub-menu").hide(),s(".menu-item-has-children").removeClass("active")}var o;s('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){var o,a,t;location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname&&(t=s(this.hash),o=s("#masthead").outerHeight(),(t=t.length?t:s("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),a=t.offset().top-o-100,s("html, body").animate({scrollTop:a},600)))}),s(".nav-browse-link").on("click",function(e){e.preventDefault();var o=s(this).attr("href"),a=s(o).offset().top-s("#masthead").outerHeight()-120;s("html, body").animate({scrollTop:a},600)}),function(){var e=window.location.hash,o=s("#masthead").outerHeight();{var a,t;!e||(a=s(e)).length&&(t=a.offset().top,jQuery("html, body").animate({scrollTop:t-o-120},600))}}(),s(".menu-toggle").on("click",function(e){e.preventDefault();var o=s("#menu-mobile");o.hasClass("open")?(o.removeClass("open"),s("body").removeClass("open"),s(this).attr("aria-expanded","false"),s("html,body").removeClass("hidden")):(o.addClass("open"),s("body").addClass("open"),s(this).attr("aria-expanded","true"),s("html,body").addClass("hidden")),a()}),s(".overlay").on("click",function(){s("#menu-mobile").removeClass("open"),s("html,body").removeClass("hidden"),a(),s("body").removeClass("open")}),o=s("<input>"),s(".clipboard").on("click",function(){console.log(1),s("body").append(o);var e=s(this).attr("href");o.val(e).select(),document.execCommand("copy"),o.remove(),s(".copied").addClass("active"),setTimeout(function(){s(".copied").removeClass("active")},2e3)})}),s(document).ready(function(e){e(".post-list .description .read-more").remove(),e("#wellcomeModal").modal("show"),s(".js-search-form").on("click",function(){s("#search-form").addClass("active")}),s(".bg-searchform").on("click",function(){s("#search-form").removeClass("active")}),0<e("body").find(".carousel-blocks").length?e(".entry-header .entry-title").addClass("sr-only"):(e(".site-header .custom-fixed-header").addClass("no-fixed"),e(".the-header").addClass("active"),e(".entry-header .entry-title").addClass("show")),o<1199&&e("#post-38 .wpgmp-map-2 .listing-map").removeClass("full-height")}),s(window).resize(function(){o=s(window).width()}),s(window).scroll(function(){var e;e=s("body").find(".carousel-blocks"),console.log(e),0<e.length?s(window).scrollTop()>s(".site-header").offset().top?s(".custom-fixed-header").addClass("fixed"):s(".custom-fixed-header").removeClass("fixed"):s(window).scrollTop()>s(".site-header").offset().top?s(".custom-fixed-header").addClass("fixed").removeClass("no-fixed"):s(".custom-fixed-header").removeClass("fixed").addClass("no-fixed")});var e,a=s(".full-height"),t=s(".the-header").height();console.log(t),e=o<375?s(window).height()-67-44:o<1199?s(window).height()-73.1-44:s(window).height()-112.4-41,a.height(e)}(jQuery);