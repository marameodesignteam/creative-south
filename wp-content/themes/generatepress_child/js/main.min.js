...
!function(i){i(window).width();0<i(".facet-search").length&&i(".facet-search").offset().top,i(window).on("load",function(){function a(){i(".mega-indicator-button").attr("aria-expanded","false"),i(".sub-menu").hide(),i(".menu-item-has-children").removeClass("active")}i("#mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-item > a.mega-menu-link").removeAttr("aria-expanded"),i('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){var a,t,n;location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname&&(n=i(this.hash),a=i("#masthead").outerHeight(),(n=n.length?n:i("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),t=n.offset().top-a-20,i("html, body").animate({scrollTop:t},600)))}),function(){var e=window.location.hash,a=i("#masthead").outerHeight();{var t,n;!e||(t=i(e)).length&&(n=t.offset().top,jQuery("html, body").animate({scrollTop:n-a-20},600))}}(),i("#menu-primary-menu > li.menu-item-has-children > a, #menu-primary-menu > li.menu-item-has-children li.menu-item-has-children > a").each(function(){i(this).unbind(),i(this).removeAttr("aria-expanded"),i(this).removeAttr("aria-haspopup");var e=i(this).next(),a=i(this).closest("li"),t=a.attr("id");e.attr("id",t+"_ul");var n=i("<button class='mega-indicator mega-indicator-button top-level d-xl-none'><span class='sr-only'>"+i(this).text()+" submenu</span></button>");n.attr("aria-controls",t+"_ul"),n.attr("aria-expanded","false"),n.insertAfter(i(this)),a.addClass("mega-with-button"),i(this).find(".mega-indicator:not(.mega-indicator-button)").remove(),a.addClass("js")}),i("body").on("click",".mega-indicator-button",function(){i(this).parent("li").toggleClass("active"),"false"==i(this).attr("aria-expanded")?i(this).attr("aria-expanded","true"):i(this).attr("aria-expanded","false"),i(this).next(".sub-menu").slideToggle()}),i(".menu-toggle").on("click",function(){var e=i("#menu-mobile");e.hasClass("open")?(e.removeClass("open"),i("body").removeClass("open"),i(this).attr("aria-expanded","false"),i("html,body").removeClass("hidden")):(e.addClass("open"),i("body").addClass("open"),i(this).attr("aria-expanded","true"),i("html,body").addClass("hidden")),a()}),i(".overlay").on("click",function(){i("#menu-mobile").removeClass("open"),i("html,body").removeClass("hidden"),a(),i("body").removeClass("open")})}),i(document).ready(function(e){e(".post-list .description .read-more").remove(),e("#wellcomeModal").modal("show"),i(".js-search-form").on("click",function(){i("#search-form").addClass("active")}),i(".bg-searchform").on("click",function(){i("#search-form").removeClass("active")})}),i(window).resize(function(){i(window).width()}),i(window).scroll(function(){})}(jQuery);