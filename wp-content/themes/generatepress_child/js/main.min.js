...
!function(n){n(window).width();0<n(".facet-search").length&&n(".facet-search").offset().top,n(window).on("load",function(){function a(){n(".mega-indicator-button").attr("aria-expanded","false"),n(".sub-menu").hide(),n(".menu-item-has-children").removeClass("active")}var t,o;n("#mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-item > a.mega-menu-link").removeAttr("aria-expanded"),n('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){var a,t,o;location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname&&(o=n(this.hash),a=n("#masthead").outerHeight(),(o=o.length?o:n("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),t=o.offset().top-a-20,n("html, body").animate({scrollTop:t},600)))}),function(){var e=window.location.hash,a=n("#masthead").outerHeight();{var t,o;!e||(t=n(e)).length&&(o=t.offset().top,jQuery("html, body").animate({scrollTop:o-a-20},600))}}(),n("#menu-primary-menu > li.menu-item-has-children > a, #menu-primary-menu > li.menu-item-has-children li.menu-item-has-children > a").each(function(){n(this).unbind(),n(this).removeAttr("aria-expanded"),n(this).removeAttr("aria-haspopup");var e=n(this).next(),a=n(this).closest("li"),t=a.attr("id");e.attr("id",t+"_ul");var o=n("<button class='mega-indicator mega-indicator-button top-level d-xl-none'><span class='sr-only'>"+n(this).text()+" submenu</span></button>");o.attr("aria-controls",t+"_ul"),o.attr("aria-expanded","false"),o.insertAfter(n(this)),a.addClass("mega-with-button"),n(this).find(".mega-indicator:not(.mega-indicator-button)").remove(),a.addClass("js")}),n("body").on("click",".mega-indicator-button",function(){n(this).parent("li").toggleClass("active"),"false"==n(this).attr("aria-expanded")?n(this).attr("aria-expanded","true"):n(this).attr("aria-expanded","false"),n(this).next(".sub-menu").slideToggle()}),n(".menu-toggle").on("click",function(){var e=n("#menu-mobile");e.hasClass("open")?(e.removeClass("open"),n("body").removeClass("open"),n(this).attr("aria-expanded","false"),n("html,body").removeClass("hidden")):(e.addClass("open"),n("body").addClass("open"),n(this).attr("aria-expanded","true"),n("html,body").addClass("hidden")),a()}),n(".overlay").on("click",function(){n("#menu-mobile").removeClass("open"),n("html,body").removeClass("hidden"),a(),n("body").removeClass("open")}),t=n("<input>"),o=n(location).attr("href"),n(".clipboard").on("click",function(e){e.preventDefault(),n("body").append(t),t.val(o).select(),document.execCommand("copy"),t.remove(),n(".copied").addClass("active"),setTimeout(function(){n(".copied").removeClass("active")},2e3)})}),n(document).ready(function(e){e(".post-list .description .read-more").remove(),e("#wellcomeModal").modal("show"),n(".js-search-form").on("click",function(){n("#search-form").addClass("active")}),n(".bg-searchform").on("click",function(){n("#search-form").removeClass("active")}),0<e("body").find(".carousel-blocks").length?e(".entry-header .entry-title").addClass("sr-only"):(e(".site-header .custom-fixed-header").addClass("no-fixed"),e(".the-header").addClass("active"),e(".entry-header .entry-title").addClass("show"))}),n(window).resize(function(){n(window).width()}),n(window).scroll(function(){var e;e=n("body").find(".carousel-blocks"),console.log(e),0<e.length?n(window).scrollTop()>n(".site-header").offset().top?n(".custom-fixed-header").addClass("fixed"):n(".custom-fixed-header").removeClass("fixed"):n(window).scrollTop()>n(".site-header").offset().top?n(".custom-fixed-header").addClass("fixed").removeClass("no-fixed"):n(".custom-fixed-header").removeClass("fixed").addClass("no-fixed")})}(jQuery);