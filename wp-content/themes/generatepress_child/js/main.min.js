...
!function(n){var o=n(window).width();function t(){if(""!=function(e){for(var o=e+"=",t=decodeURIComponent(document.cookie).split(";"),a=0;a<t.length;a++){for(var n=t[a];" "==n.charAt(0);)n=n.substring(1);if(0==n.indexOf(o))return n.substring(o.length,n.length)}return""}("visited"))return 1;!function(e,o,t){var a=new Date;a.setTime(a.getTime()+24*t*60*60*1e3);var n="expires="+a.toGMTString();document.cookie=e+"="+o+";"+n+";path=/"}("visited",!0,30)}0<n(".facet-search").length&&n(".facet-search").offset().top,n(window).on("load",function(){function t(){n(".mega-indicator-button").attr("aria-expanded","false"),n(".sub-menu").hide(),n(".menu-item-has-children").removeClass("active")}var o;n('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){var o,t,a;n("#menu-mobile").removeClass("open"),n("body").removeClass("open"),n(".menu-toggle").attr("aria-expanded","false"),n("html,body").removeClass("hidden"),location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname&&(a=n(this.hash),o=n("#masthead").outerHeight(),(a=a.length?a:n("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),t=a.offset().top-o-100,n("html, body").animate({scrollTop:t},600)))}),n(".nav-browse-link").on("click",function(e){e.preventDefault();var o=n(this).attr("href"),t=n(o).offset().top-n("#masthead").outerHeight()-120;n("html, body").animate({scrollTop:t},600)}),function(){var e=window.location.hash,o=n("#masthead").outerHeight();{var t,a;!e||(t=n(e)).length&&(a=t.offset().top,jQuery("html, body").animate({scrollTop:a-o-120},600))}}(),n(".menu-toggle").on("click",function(e){e.preventDefault();var o=n("#menu-mobile");o.hasClass("open")?(o.removeClass("open"),n("body").removeClass("open"),n(this).attr("aria-expanded","false"),n("html,body").removeClass("hidden")):(o.addClass("open"),n("body").addClass("open"),n(this).attr("aria-expanded","true"),n("html,body").addClass("hidden")),t()}),n(".overlay").on("click",function(){n("#menu-mobile").removeClass("open"),n("html,body").removeClass("hidden"),t(),n("body").removeClass("open")}),o=n("<input>"),n(".clipboard").on("click",function(){console.log(1),n("body").append(o);var e=n(this).attr("href");o.val(e).select(),document.execCommand("copy"),o.remove(),n(".copied").addClass("active"),setTimeout(function(){n(".copied").removeClass("active")},2e3)})}),n(document).ready(function(e){e(".post-list .description .read-more").remove(),e("#welcomeModal").length&&(t()||e("#welcomeModal").modal("show")),n(".js-search-form").on("click",function(){n("#search-form").addClass("active")}),n(".bg-searchform").on("click",function(){n("#search-form").removeClass("active")}),0<e("body").find(".carousel-blocks").length?e(".entry-header .entry-title").addClass("sr-only"):(e(".site-header .custom-fixed-header").addClass("no-fixed"),e(".the-header").addClass("active"),e(".entry-header .entry-title").addClass("show")),o<1199&&e("#post-38 .wpgmp-map-2 .listing-map").removeClass("full-height")}),n(window).resize(function(){o=n(window).width()}),n(window).scroll(function(){var e;e=n("body").find(".carousel-blocks"),console.log(e),0<e.length?n(window).scrollTop()>n(".site-header").offset().top?n(".custom-fixed-header").addClass("fixed"):n(".custom-fixed-header").removeClass("fixed"):n(window).scrollTop()>n(".site-header").offset().top?n(".custom-fixed-header").addClass("fixed").removeClass("no-fixed"):n(".custom-fixed-header").removeClass("fixed").addClass("no-fixed")});var e,a=n(".full-height");n(".the-header").height();e=o<375?n(window).height()-67-44:o<1199?n(window).height()-73.1-44:n(window).height()-112-41,a.height(e)}(jQuery);