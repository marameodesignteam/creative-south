...
!function(i){var e=i(window).width();0<i(".facet-search").length&&i(".facet-search").offset().top,i(window).on("load",function(){function t(){i(".mega-indicator-button").attr("aria-expanded","false"),i(".sub-menu").hide(),i(".menu-item-has-children").removeClass("active")}var o,a;i(".nav-browse-link").on("click",function(e){e.preventDefault();var o=i(this).attr("href"),t=i(o).offset().top-i("#masthead").outerHeight()-120;i("html, body").animate({scrollTop:t},600)}),function(){var e=window.location.hash,o=i("#masthead").outerHeight();{var t,a;!e||(t=i(e)).length&&(a=t.offset().top,jQuery("html, body").animate({scrollTop:a-o-120},600))}}(),i(".menu-toggle").on("click",function(e){e.preventDefault();var o=i("#menu-mobile");o.hasClass("open")?(o.removeClass("open"),i("body").removeClass("open"),i(this).attr("aria-expanded","false"),i("html,body").removeClass("hidden")):(o.addClass("open"),i("body").addClass("open"),i(this).attr("aria-expanded","true"),i("html,body").addClass("hidden")),t()}),i(".overlay").on("click",function(){i("#menu-mobile").removeClass("open"),i("html,body").removeClass("hidden"),t(),i("body").removeClass("open")}),o=i("<input>"),a=i(location).attr("href"),i(".clipboard").on("click",function(e){e.preventDefault(),i("body").append(o),o.val(a).select(),document.execCommand("copy"),o.remove(),i(".copied").addClass("active"),setTimeout(function(){i(".copied").removeClass("active")},2e3)})}),i(document).ready(function(t){t(".post-list .description .read-more").remove(),t("#wellcomeModal").modal("show"),i(".js-search-form").on("click",function(){i("#search-form").addClass("active")}),i(".bg-searchform").on("click",function(){i("#search-form").removeClass("active")}),0<t("body").find(".carousel-blocks").length?t(".entry-header .entry-title").addClass("sr-only"):(t(".site-header .custom-fixed-header").addClass("no-fixed"),t(".the-header").addClass("active"),t(".entry-header .entry-title").addClass("show")),e<1199&&t("#post-38 .wpgmp-map-2 .listing-map").removeClass("full-height"),t(".tour-item-infor .more-info").on("click",function(){var e=t(this).parents(".tour-item"),o=t(this).parents(".tour-item").attr("id");console.log(o),t(this).toggleClass("active"),e.find(".collapseTour-item").slideToggle(),t("#"+o+" .place_title").click()})}),i(window).resize(function(){e=i(window).width()}),i(window).scroll(function(){var e;e=i("body").find(".carousel-blocks"),console.log(e),0<e.length?i(window).scrollTop()>i(".site-header").offset().top?i(".custom-fixed-header").addClass("fixed"):i(".custom-fixed-header").removeClass("fixed"):i(window).scrollTop()>i(".site-header").offset().top?i(".custom-fixed-header").addClass("fixed").removeClass("no-fixed"):i(".custom-fixed-header").removeClass("fixed").addClass("no-fixed")});var o,t=i(".full-height"),a=i(".the-header").height();console.log(a),o=e<375?i(window).height()-67-44:e<1199?i(window).height()-73.1-44:i(window).height()-112.4-41,t.height(o)}(jQuery);